const advantages = [
  ...
  },
  {
    ...
    description:
      "Ankara ofisimizde birebir görüşme imkânı sunuyoruz. İhtiyaçlarınızı yüz yüze dinliyor, en uygun çözümü birlikte oluşturuyoruz.",
  },
  {
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
export default function WhyUsSection() {
  return (
    <section id="neden-biz" className="relative py-24 bg-navy-800 overflow-hidden">
