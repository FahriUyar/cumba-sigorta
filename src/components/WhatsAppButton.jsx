...
export default function WhatsAppButton() {
  ...
  useEffect(() => {
    ...
    // Show tooltip after 3 seconds if visible
  ...
  return (
    ...
    >
      ...
      >
        <div className="bg-navy-800 text-white text-sm px-4 py-2 rounded-xl shadow-xl whitespace-nowrap font-medium">
          Bize Yazın! 💬
          <div className="absolute -bottom-1 right-5 w-3 h-3 bg-navy-800 rotate-45" />
        </div>
      </div>
